...
#include "fox_cmds.h"       // User defined command set for this application
#include "cmd_fox_palette.h"       // Application class definition
#include "fox_palette.h"    // TTestWindow class definition
...
// Disable standalone entrypoint when linked into dottalkpp.
#ifndef FOX_PALETTE_AS_LIBRARY
