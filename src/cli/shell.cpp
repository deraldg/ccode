...
void cmd_SKIP     (xbase::DbArea&, std::istringstream&);
...
void cmd_VALIDATE        (xbase::DbArea&, std::istringstream&);
...
// Relations handlers (implemented in set_relations.cpp)
void cmd_SET_RELATIONS     (xbase::DbArea&, std::istringstream&);
void cmd_RELATIONS_REFRESH (xbase::DbArea&, std::istringstream&);
void cmd_RELATIONS_LIST    (xbase::DbArea&, std::istringstream&);
#endif

void cmd_SELECT   (xbase::DbArea&, std::istringstream&);
//void cmd_ALIAS    (xbase::DbArea&, std::istringstream&);
...
void cmd_WSREPORT (xbase::DbArea&, std::istringstream&);
...
//      registry().add("PALETTE",      [](DbArea& A, std::istringstream& S){ cmd_PALETTE(A,S); });
    ...
    registry().add("APPEND_BLANK",[](DbArea& A, std::istringstream& S){ cmd_APPEND_BLANK(A,S); });
    ...
    registry().add("SELECT",      [](DbArea& A, std::istringstream& S){ cmd_SELECT(A,S); });
//  registry().add("ALIAS",       [](DbArea& A, std::istringstream& S){ cmd_ALIAS(A,S); });
...
// Relationships
    registry().add("SET_RELATION",[](DbArea& A, std::istringstream& S){ cmd_SET_RELATIONS(A,S); });
...
// (optional convenience aliases)
    ...
    registry().add("REL",         [](DbArea& A, std::istringstream& S){ cmd_RELATIONS_LIST(A,S); });
#endif
